...
time_math = no_g{1}.Values.Time;
response_math = no_g{1}.Values.Data;
...
xlabel('Time (s)');
ylabel('Response');
title('System with Gravity Compensation Response');
grid on;
legend({'System Response', 'Peak Time', 'Settling Time', 'Final Value'}, 'FontSize', 9);
...
xlabel('Time (s)');
ylabel('Response');
title('System without Gravity Compensation Response');
grid on;
legend({'System Response', 'Peak Time', 'Settling Time', 'Final Value'}, 'FontSize', 9);
